...
class FixedArrayContainerTemplate : public ContainerTemplate<> {
...
public:
    ...
    virtual std::unique_ptr<ContainerType<> > instantiate(TemplateInstanceCache *instanceCache, const Type *elementType) const override;
