...
class StaticArrayContainerTemplate : public ContainerTemplate<const Type *, int> {
...
public:
    ...
    virtual std::unique_ptr<ContainerType<const Type *, int> > instantiate(TemplateInstanceCache *, const Type *elementType, int length) const override;
