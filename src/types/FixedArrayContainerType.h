...
public:
    ...
    std::string generateCopyFromArrayContainer(const std::string &indent, const char *subject, const char *x) const;
    std::string generateMoveFromArrayContainer(const std::string &indent, const char *subject, const char *x) const;
